                ...
                <Card className={`border-0 shadow rounded-4 overflow-hidden mb-4 border-top border-4 ${result.isMalignant ? 'border-danger' : 'border-success'}`}>
                  ...
                  <Card.Body className="p-4">
                    ...
                    <div className="mb-4">
                      <div className="d-flex justify-content-between align-items-center mb-3">
                        <h6 className="fw-bold mb-0 text-dark d-flex align-items-center">
                          {result.isMalignant ? (
                            <>
                              <FaCheckCircle className="me-2 text-danger" /> Explainable AI (Grad-CAM Visualizations)
                            </>
                          ) : (
                            <>
                    ...
                    <div className="mb-4 p-3 bg-light rounded-4 border-start border-4 border-primary">
                      ...
                      <div className="small text-dark mb-2">
                        <strong>Model Explanation:</strong> {result.isMalignant ? 'Grad-CAM highlights specific cellular regions corresponding to deep-learning features of pleomorphic nuclei and malignant architecture.' : 'Cellular morphology indicates normal, non-neoplastic pulmonary alveolar architecture.'}
                      </div>
                      ...
                      <ul className="small mb-0 ps-3 text-dark fw-semibold">
                        {result.followUpItems && result.followUpItems.length > 0 ? (
                          ...
                          result.isMalignant ? (
                            ...
                            <>
                              <li>Maintain routine age-appropriate preventive health check-ups.</li>
                              <li>Smoking cessation counseling if applicable.</li>
                              <li>Clinical review if new respiratory symptoms develop.</li>
                            </>
                          )
                        )}
                      </ul>
