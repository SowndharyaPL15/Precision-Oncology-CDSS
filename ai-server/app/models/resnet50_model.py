...
def build_resnet50(num_classes: int, image_shape: tuple = (224, 224, 3)) -> models.Model:
    ...
    # Optionally, we can use the specific preprocess_input here if needed, 
    # but maintaining identical pipeline to EfficientNetB0 as requested.
...
def prepare_for_fine_tuning(model: models.Model, unfreeze_layers: int = 40, learning_rate: float = 1e-5) -> models.Model:
    """
    Prepares an existing ResNet50 model for fine-tuning by unfreezing
